...
class AIAgent:
    ...
    def release_clients(self) -> None:
        ...
        # A soft cache eviction permanently discards this AIAgent instance.
        # Its Codex app-server transport cannot be reused by the replacement,
        # so retaining it only leaks the subprocess and its MCP children.
        try:
